...
ALTER TABLE "Tool" ADD COLUMN "qrData" TEXT;

UPDATE "Tool" t
SET hash = v.hash, qrData = v.hash
FROM (VALUES
...
UPDATE "Tool" SET hash = name, qrData = name WHERE hash IS NULL;

ALTER TABLE "Tool" ALTER COLUMN "hash" SET NOT NULL;
ALTER TABLE "Tool" ALTER COLUMN "qrData" SET NOT NULL;
