...
export default function Nav({ active }) {
  ...
  const mainNavItems = [
    ...
    ...(session?.user?.role === 'ADMIN' ? [{ href: '/mon-equipe', label: 'MON ÉQUIPE', key: 'mon-equipe' }] : [])
  ]
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden lg:block">
            <div className="flex items-center space-x-3">
              ...
              <button
                onClick={() => { localStorage.setItem('autoLogin', 'false'); signOut({ callbackUrl: '/' }) }}
            ...
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              <div className="border-t border-gray-200 pt-3 mt-3">
                ...
                <button
                  ...
                  className="flex w-full items-center gap-2 text-left px-3 py-2 rounded-md text-sm font-medium text-red-600 hover:bg-red-50 transition-all duration-200"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"></path>
                  </svg>
